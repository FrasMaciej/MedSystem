...
export async function getFilteredVisits(req: Request, res: Response) {
...
export async function getVisitsByPatientId(req: Request, res: Response) {
...
export async function saveDoctor(req: Request, res: Response) {
...
export async function addTerminsSlots(req: Request, res: Response) {
    const id = req.params.id;
...
export async function editVisit(req: Request, res: Response) {
